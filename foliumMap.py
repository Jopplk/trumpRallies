...
def pointMap(foliumMapOri, filename):
    foliumMap = foliumMapOri
...
def choroplethMap(foliumMapOri, filename):
    def agg(dfFile):
    ...
    bothAgg = data2016agg.combine(dataPostagg, lambda x, y: x + y, fill_value=0)
...
pointMap(usMap, 'pointF.html')
choroplethMap(usMap, 'choroF.html')
